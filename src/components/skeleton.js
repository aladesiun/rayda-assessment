    ...
    return (
        <div className='grid gap-4 mt-5 xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 my-4'>
            ...
            {Array.from(Array(8), (e, key) => (
                ...
                <div className='xl:w-[300px] w-full mx-auto border  border-b border-border   drop-shadow rounded-lg p-4' key={key}>
                    <Skeleton height={105} width={'100%'} className=""></Skeleton>
                    ...
                    <Skeleton height={36} width={'100%'} className=""></Skeleton>
                </div>
