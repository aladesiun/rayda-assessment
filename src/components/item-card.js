const ItemCard = ({ item }) => {
    return (
        <div className='border  border-b border-border   drop-shadow rounded-lg p-4 xl:w-[300px] mx-auto'>
            ...
            <p className='my-2 font-semibold text-sm'>{item.title}</p>
            <p className='my-2'><span className='text-[14px] font-light capitalize text-[#344054]'>current Bid: <span className='font-semibold text-sm'>{item.bid}</span></span></p>
